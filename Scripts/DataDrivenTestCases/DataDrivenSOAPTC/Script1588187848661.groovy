...
response1 = WS.sendRequest(findTestObject('CountryInfoService/GetCapitalNames', [('CountryCode') : CountryCode]))

WS.verifyElementText(response1, 'CapitalCityResponse.CapitalCityResult', Capital)

response2 = WS.sendRequest(findTestObject('CountryInfoService/GetCurrency', [('CountryCode') : CountryCode]))
