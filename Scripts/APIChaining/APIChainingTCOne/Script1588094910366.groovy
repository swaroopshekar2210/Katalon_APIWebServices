...
response1 = WS.sendRequestAndVerify(findTestObject('CountryInfoService/ListCountryName'))
...
WS.sendRequestAndVerify(findTestObject('CountryInfoService/GetCapitalNames'))
